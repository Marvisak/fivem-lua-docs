...
--- @return nil
--- @overload fun(object: Object, posX: number, posY: number, posZ: number, scaleX: number, scaleY: number, scaleZ: number, heading: number, flags: number): nil
...
--- @return nil
--- @overload fun(posMinX: number, posMinY: number, posMinZ: number, posMaxX: number, posMaxY: number, posMaxZ: number, bDisable: boolean): nil
