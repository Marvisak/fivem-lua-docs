...
--- ```
---
--- @hash [0x2BDD44CC428A7EAE](https://docs.fivem.net/natives/?_0x2BDD44CC428A7EAE)
---
--- @return number
--- @overload fun(): number
...
--- @overload fun(): number
--- @deprecated
function GetCurrentLanguageId() end
...
--- ```
---
--- @hash [0x497420E022796B3F](https://docs.fivem.net/natives/?_0x497420E022796B3F)
---
--- @return number
--- @overload fun(): number
...
--- # New Name: LocalizationGetSystemLanguage
--- ```
--- Same return values as GET_CURRENT_LANGUAGE
--- ```
---
