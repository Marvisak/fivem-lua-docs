...
--- @return nil
--- @overload fun(entity: Entity, x: number, y: number, z: number, keepTasks: boolean, keepIK: boolean, doWarp: boolean): nil
...
--- @return nil
--- @overload fun(entity1: Entity, entity2: Entity, boneIndex: number, xPos: number, yPos: number, zPos: number, xRot: number, yRot: number, zRot: number, p9: boolean, useSoftPinning: boolean, collision: boolean, isPed: boolean, rotationOrder: number, syncRot: boolean): nil
...
--- @return nil
--- @overload fun(entity: Entity, pitch: number, roll: number, yaw: number, rotationOrder: number, bDeadCheck: boolean): nil
