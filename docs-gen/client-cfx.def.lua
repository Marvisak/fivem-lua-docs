...
--- @return nil
--- @overload fun(modifierName: string, varName: string): nil
...
--- @return nil
--- @overload fun(modifierName: string, varName: string, value1: number, value2: number): nil
...
--- @param maxY number (int)
--- @return nil
--- @overload fun(minX: number, minY: number, maxX: number, maxY: number): nil
...
--- @return nil
--- @overload fun(vehicle: Vehicle, wheelIndex: number, leaveDebrisTrail: boolean, deleteWheel: boolean, unknownFlag: boolean, putOnFire: boolean): nil
...
--- @param id number (int)
--- @return nil, number, number
--- @overload fun(id: number): nil, number, number
...
--- @return nil
--- @overload fun(id: number, horizontalAlign: number, verticalAlign: number): nil
